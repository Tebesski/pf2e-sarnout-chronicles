...
import { lastRedoubtRegionScript } from "./last-redoubt/region-script.mjs"
...
Hooks.on("createChatMessage", async (message) => {
   ...
   if (
      ...
      const effectData = {
         ...
         type: "effect",
         img: TEMPLAR_ASSETS.lastRedoubtAc,
         system: {
...
export async function createLastStrongholdSourceEffect(actor, rank) {
   ...
   return createOrRefreshEffect(
      actor,
      {
         ...
         type: "effect",
         img: TEMPLAR_ASSETS.lastRedoubt,
         system: {
...
export async function createLastRedoubtBehavior(
   ...
   const script = lastRedoubtRegionScript({
      moduleId: MODULE_ID,
